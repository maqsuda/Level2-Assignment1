...
To build reusable, strictly typed components by using type parameters as placeholders instead of specific data types. When you define a function or class with a generic (often denoted as <T>), you defer the decision of which specific type to use until the code is actually called or instantiated
...
** Code DRY **
write the logic once and apply it infinitely across different data shapes.

1. write the algorithm (sorting, filtering, wrapping) once.
